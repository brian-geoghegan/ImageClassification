...
img_path = '/home/ubuntu/data/omelette_2.jpg'
img = image.load_img(img_path, target_size=(200, 200))
image = image.img_to_array(img)
# Load a compiled model
model = Sequential()
trained_model = load_model('fine_tuned_InceptionV3_1.h5')
...
le.fit(["chicken_curry", "hamburger", "omelette", "pancakes", "spaghetti_bolognese", "waffles"])
print(le.classes_)
# classify the image
