...
checkpoint = ModelCheckpoint("fine_tuned_vgg19_1.h5", monitor='val_acc', verbose=1, save_best_only=True, save_weights_only=False, mode='auto', period=1)
...
plt.savefig('/home/ubuntu/data/cnn_VGG19.png')
